...
public class GPUFlock : MonoBehaviour {
    ...
    //private float randomXAxes = 0;
    //private float randomZAxes = 0;
    void Update()
    {
        ...
        //{
        //    randomTimer = 0;
        //    randomXAxes = Random.Range(-0.2f, 0.2f);
        //    randomZAxes = Random.Range(-0.2f, 0.2f);
        //}

        this.targetPos += new Vector3(2f, 5f, 2f); 
        ...
        Debug.Log("targetPos =" + this.transform.localPosition);
