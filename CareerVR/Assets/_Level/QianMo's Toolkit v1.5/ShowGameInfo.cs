...
public class ShowGameInfo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (ShowGUI)
        {
            ...
            //---------------------------【左下方的控制说明】--------------------------
             //创建一个矩形区域
             GUI.Box(new Rect(0, Screen.height - 180, 300, 180), "控制说明");
         
            //输出文字说明
             GUI.Label(new Rect(0, Screen.height - 150, 300, 170), " 程序退出： 键盘【Esc】");
             GUI.Label(new Rect(0, Screen.height - 130, 300, 170), " 开启/关闭屏幕特效：键盘【F】");
             GUI.Label(new Rect(0, Screen.height - 110, 300, 170), " 位置移动： 键   盘【W】、【A】、【S】、【D】");
             GUI.Label(new Rect(0, Screen.height - 90, 300, 170), "                  方向键【↑】、【↓】、【←】、【→】");
             GUI.Label(new Rect(0, Screen.height - 70, 300, 170), "                  小键盘【8】、【4】、【5】、【6】");
             GUI.Label(new Rect(0, Screen.height - 50, 300, 170), " 视角移动： 鼠标");
             GUI.Label(new Rect(0, Screen.height - 30, 300, 170), " 跳       跃： 键盘【Space】");
